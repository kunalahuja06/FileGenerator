...
namespace FileGenerator
{
    ...
    internal sealed class GenerateCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("5105448e-d346-4ef6-813a-f0b745041d8d");
        ...
        {
            // Switch to the main thread - the call to AddCommand in Generate Command's constructor requires
            // the UI thread.
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            patternControl.SetParentWindow(window);
            window.ShowDialog();
        }
    }
}
